...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Memoizes an Object (in these cases an Integer of 0, then 1),
    # and performs a block or operand on each item in the enumerable,
    # such that the memoized item is mutated until all items have been parsed.
  end
  ...
  #   # code to read 'file'
  #
  # Because we would only want to execute the do block if the file
  # successfully opened.
